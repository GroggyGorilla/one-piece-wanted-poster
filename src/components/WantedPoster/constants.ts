...
export const ONE_PIECE_WANTED_IMAGE: WantedImageInfo = {
  ...
  footerTitlePosition: { x: -100, y: 1040, width: 400, height: 26 },
  footerTextPosition: { x: -100, y: 1070, width: 400, height: 18 },
  footerText2Position: { x: -100, y: 1090, width: 400, height: 18 },
  footerText3Position: { x: -100, y: 1110, width: 400, height: 18 },
  footerText4Position: { x: -100, y: 1130, width: 400, height: 18 },
  bountyInfo: {
    x: 82,
    y: 958,
    width: 592,
