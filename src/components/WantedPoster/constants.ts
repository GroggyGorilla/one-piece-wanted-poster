...
export const ONE_PIECE_WANTED_IMAGE: WantedImageInfo = {
  ...
  footerTitlePosition: { x: -100, y: 1040, width: 350, height: 26 },
  footerTextPosition: { x: -90, y: 1070, width: 350, height: 20 },
  footerText2Position: { x: -90, y: 1095, width: 350, height: 20 },
  footerText3Position: { x: -90, y: 1120, width: 350, height: 20 },
  footerText4Position: { x: -90, y: 1145, width: 350, height: 20 },
  bountyInfo: {
    x: 82,
    y: 958,
    width: 592,
